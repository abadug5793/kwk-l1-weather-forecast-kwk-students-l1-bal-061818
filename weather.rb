...
def weather_report(weather)
	return "The weather is #{location(weather)} is #{description(weather)}. The temperature is #{weather[:temperature_farenheit]} degrees Farenheit"
end
...
def city_weather_info(weather)
	return "The city is #{location(weather)}"
	return "The description is #{description(weather)}"
	return "THe temperature is #{weather[:temperature_farenheit]}"
end
